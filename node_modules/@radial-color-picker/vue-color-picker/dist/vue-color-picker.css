...
.rcp__well.pressed {
    -webkit-animation: rcp-beat 0.4s cubic-bezier(0.35, 0, 0.25, 1) forwards;
...
.rcp__ripple.rippling {
    z-index: 0;
    -webkit-animation: rcp-ripple 0.5s cubic-bezier(0.35, 0, 0.25, 1) forwards;
